...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50">
      {/* Top Contact Bar */}
      <div className="bg-gray-900 text-white py-1 md:py-2">
        <div className="container mx-auto px-2 md:px-4 flex flex-wrap justify-between items-center">
          <div className="flex items-center space-x-1 md:space-x-2 lg:space-x-4">
            <a href="tel:+917620086320" className="text-xs md:text-sm flex items-center hover:text-accent">
              ...
              <span className="hidden sm:inline">+91 7620086320</span>
              <span className="sm:hidden">+91 7620086320</span>
            </a>
            <a href="mailto:info@suvidhafoundationedutech.org" className="text-xs md:text-sm flex items-center hover:text-accent">
              <svg className="h-3 w-3 md:h-4 md:w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span className="hidden lg:inline">info@suvidhafoundationedutech.org</span>
              <span className="lg:hidden">info@suvidha...</span>
            </a>
          </div>
      ...
      <div className="bg-white shadow-md">
        <div className="container mx-auto py-1 md:py-2 lg:py-4 px-2 md:px-4 flex justify-between items-center">
          <div className="flex items-center">
            <Link href="/" className="flex items-center">
              <div className="relative w-28 h-8 sm:w-32 sm:h-10 md:w-52 md:h-16">
                <Image
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-white shadow-md border-t">
          <div className="container mx-auto px-2 md:px-4 py-1 md:py-2 lg:py-3 space-y-1 md:space-y-2 lg:space-y-3">
